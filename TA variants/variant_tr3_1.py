...
xvals = np.linspace(-5.12, 5.12, 300)    # rastrigin
yvals = np.linspace(-5.12, 5.12, 300)
# xvals = np.linspace(-512, 512, 300)     #eggholder
...
#             onfunc=eggholder(x, y)
            ...
            if firstTime==True:
                if z < onfunc:
                    ...
                    isUnderneath = False
#                 print("Is underneath",isUnderneath)
                firstTime = False
#             print("Examine (",x,",",y,",",z,")")
#             print("Function has ",onfunc)
...
# wb = Workbook() 
#  
# sheet1 = wb.add_sheet('variantTR3_rastrigin')
# i=0
# for wr in results:
#     sheet1.write(i, 0, wr)
...
#     i+=1
#     
# wb.save('variantTR3_rastrigin.xls')
# print("All saved")